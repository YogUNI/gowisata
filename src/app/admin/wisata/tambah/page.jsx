...
export default function TambahWisataPage() {
  ...
  try {
    const newWisata = addWisata(formData); // ✅ REAL SAVE!
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-300">Isi form di bawah untuk menambahkan destinasi wisata</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
