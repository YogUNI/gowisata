...
export default function DetailWisataPage() {
  ...
  const getMapUrl = () => {
    if (wisata?.coordinates?.lat && wisata?.coordinates?.lng) {
      // Use exact coordinates
      return `https://www.google.com/maps/embed/v1/place?key=YOUR_API_KEY&q=${wisata.coordinates.lat},${wisata.coordinates.lng}&zoom=15`;
    } else {
      // Auto-search using name + location
