        ...
        <div className="p-4 rounded-xl" style={{ background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)" }}>
          ...
          <div className="flex items-center gap-3 bg-white rounded-xl p-2">
            <button
              ...
              disabled={durasi <= 1}
              className={`w-10 h-10 flex items-center justify-center rounded-lg transition-all duration-200 flex-shrink-0 ${
                durasi <= 1
              ...
              <div className="max-h-48 overflow-y-auto">
                {filteredKota.map((prov) => (
                  <div
                    ...
                    className={`p-3 cursor-pointer hover:bg-pink-50 transition-all text-gray-800 ${
                      kota === prov.name ? "bg-pink-100 font-bold text-pink-700" : ""
                    }`}
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredDestinations.map((dest, index) => {
            ...
            return (
              <div
                key={dest.id}
                className={`bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500 cursor-pointer group ${
