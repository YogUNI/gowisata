...
import { addWisata, provincesData } from "@/lib/data/WisataData";
...
export default function TambahWisataPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const newWisata = addWisata(cleanData);
      console.log("✅ New Wisata:", newWisata);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Tambah Wisata Baru</h2>
          <p className="text-gray-300">Isi semua informasi destinasi wisata dengan lengkap</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:scale-105"
            >
              {loading ? (
                <>
