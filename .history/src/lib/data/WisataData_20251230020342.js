...
export const defaultWisataData = [
  ...
  { id: 35, name: "Museum Angkut", province: "Jawa Timur", category: "alam", price: "Rp 20.000", priceNum: 20000, htmLokal: "Rp 20.000", htmTuris: "Rp 30.000", image: `/images/${slugify("Tumpak Sewu")}.jpg`, gallery: [`/images/${slugify("Tumpak Sewu")}.jpg`], videoUrl: null, ...getCategoryDefaults("alam"), tips: "", coordinates: null, hotelTerdekat: [] },
